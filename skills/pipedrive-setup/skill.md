...
description: First-run setup for the Pipedrive MCP plugin. Prompts for API credentials and writes the MCP server configuration to Claude Code settings. Includes full CADTALK custom field reference for all Pipedrive entities.
---
